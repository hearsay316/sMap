...
function inputLink(inc){
    //if (!isWinRT) {
        var link = '<' + 'link rel="stylesheet" type="text/css" media="screen,projection" href="webgl/examples/js/plotPanelControl/' + inc + '"' + '><' + '/>';
...
function inputScript(inc){
    //if (!isWinRT) {
        var script = '<' + 'script type="text/javascript" src="webgl/examples/js/plotPanelControl/' + inc + '"' + '><' + '/script>';
